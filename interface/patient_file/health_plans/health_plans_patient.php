...
switch($task) {
    ...
    case "update" : {
        ...
        sqlQuery("delete from patient_reminders where plan_id=? and patient_id=?", array($enrollrow['plan_id'], $pid));
...
else
{
    ...
    <input type=hidden name=task value=delete>
        <tr height=\"24\" style=\"background:lightgrey\">
            ...
            <td width=\"\" style=\"border-bottom: 1px #000000 solid; border-right: 1px #000000 solid;\" class=bold>&nbsp;<b>".htmlspecialchars(xl('Plan'), ENT_QUOTES)."</b> $sortlink[1]</td>
	    <td width=\"25%\" style=\"border-bottom: 1px #000000 solid; border-right: 1px #000000 solid;\" class=bold>&nbsp;<b>".htmlspecialchars(xl('Signup Date'), ENT_QUOTES)."</b> $sortlink[0]</td>
